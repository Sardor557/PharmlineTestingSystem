            ...
            modelBuilder.Entity("PharmlineTestingSystem.Models.tbUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 11, 19, 15, 48, 4, 55, DateTimeKind.Local).AddTicks(6991),
                            CreateUser = 1,
                            FIO = "Admin",
                            Login = "admin",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 11, 19, 15, 48, 4, 55, DateTimeKind.Local).AddTicks(7041),
                            CreateUser = 1,
                            FIO = "Gavxar",
                            Login = "director",
                            Password = "bf6e55cd42d6d5dedfafcdd05ba5d8b8",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 11, 19, 15, 48, 4, 55, DateTimeKind.Local).AddTicks(7076),
                            CreateUser = 1,
                            FIO = "Jenya",
                            Login = "manager",
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 11, 19, 15, 48, 4, 55, DateTimeKind.Local).AddTicks(7110),
                            CreateUser = 1,
                            FIO = "Sklad",
                            Login = "sklad",
