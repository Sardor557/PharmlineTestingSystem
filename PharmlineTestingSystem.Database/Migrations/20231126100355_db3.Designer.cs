            ...
            modelBuilder.Entity("PharmlineTestingSystem.Models.tbUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 11, 26, 15, 3, 55, 348, DateTimeKind.Local).AddTicks(8717),
                            CreateUser = 1,
                            FIO = "Admin",
                            Login = "admin",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 11, 26, 15, 3, 55, 348, DateTimeKind.Local).AddTicks(8781),
                            CreateUser = 1,
                            FIO = "Gavxar",
                            Login = "director",
                            Password = "bf6e55cd42d6d5dedfafcdd05ba5d8b8",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 11, 26, 15, 3, 55, 348, DateTimeKind.Local).AddTicks(8817),
                            CreateUser = 1,
                            FIO = "Jenya",
                            Login = "manager",
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 11, 26, 15, 3, 55, 348, DateTimeKind.Local).AddTicks(8863),
                            CreateUser = 1,
                            FIO = "Sklad",
                            Login = "sklad",
